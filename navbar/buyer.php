...
<a class="col-md-1" href="">My Cart</a>
<a class="col-md-1" href="<?php if (strpos($url, 'http://localhost/eComm/profiles/prof_buyer.php') == 'true') echo 'nav-active' ?>">My Profile</a>
<a class="col-md-1" href="">Logout</a>